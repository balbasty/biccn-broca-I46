...
folder = '/projectnb2/npbssmic/ns/Ann_Mckee_samples_10T/CTE_8572/';      % OCT file path                          ADJUST FOR EACH SAMPLE!!! 
P2path = '/projectnb2/npbssmic/ns/Ann_Mckee_samples_10T/CTE_8572_2P/';   % 2P file path                           ADJUST FOR EACH SAMPLE!!!
datapath=strcat(folder,'dist_corrected/'); 
nslice=21; % define total number of slices                                                                       ADJUST FOR EACH SAMPLE!!!
...
ds_factor=10;     % downsampling factor, 4 means 4x4 pixel downsample, which is 12x12um pixel size                ADJUST FOR EACH SAMPLE!!!
...
%       Optical_fitting_finalized(co, cross, s_seg, z_seg, datapath,aip_threshold, mus_depth, bfg_depth, ds_factor, zf, zf_tilt)
        Optical_fitting_finalized(co, cross, islice, iFile, folder,      0.045,       130,       100,     ds_factor, 48,    10);
