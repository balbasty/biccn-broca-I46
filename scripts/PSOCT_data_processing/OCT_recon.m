...
OCTpath  = '/projectnb2/npbssmic/ns/Ann_Mckee_samples_10T/NC_8095/';  % OCT data path.              ADJUST FOR EACH SAMPLE!!!
P2path = '/projectnb2/npbssmic/ns/Ann_Mckee_samples_10T/NC_8095_2P/';  % 2P data path.
% leave unchanged if no 2P data is avalable                                                    ADJUST FOR EACH SAMPLE!!!
nslice=24;   % total number of imaging slices.                                                 ADJUST FOR EACH SAMPLE!!!
